...
from routers import user, bank_account, income, budget, dashboard, expense, friend # Import the new friend router
...
app.include_router(friend.router) # Add the new friend router
